...
export default {
    ...
    methods:{
        clickSave:async function(){
            await axios.patch('https://3002-b95582b4-ae68-4f74-ad61-58cb4afbe719.ws-eu03.gitpod.io/savedGames/' + this.$store.state.username, {
                stats:{
        ...
        confirmDelete:async function(){
            let userResponse = await axios.get('https://3002-b95582b4-ae68-4f74-ad61-58cb4afbe719.ws-eu03.gitpod.io/users/' + this.$store.state.username)
            this.user=userResponse.data
            if(this.deletePassword === this.user.password){
                await axios.delete('https://3002-b95582b4-ae68-4f74-ad61-58cb4afbe719.ws-eu03.gitpod.io/users/' + this.$store.state.username)
                await axios.delete('https://3002-b95582b4-ae68-4f74-ad61-58cb4afbe719.ws-eu03.gitpod.io/savedGames/' + this.$store.state.username)
